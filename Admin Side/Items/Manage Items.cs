...
namespace sims.Admin_Side.Items
{
    public partial class Manage_Items : Form
    {
        ...
        public Manage_Items(Old_Inventory_Dashboard inventoryDashboard, Manage_Categoryy dashboardForm)
        {
            InitializeComponent();
        ...
        {
            // Then, refresh the search combo box itself
            searchCategoryCmb.Items.Clear();
            DataTable table = Manage_Categoryy.GetCategoriesData();
        ...
        private void NewItemBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                _newItems = new New_Items(this, this, dashboardForm, _inventoryDashboard);
                _newItems.Show();
            }
            else
            {
